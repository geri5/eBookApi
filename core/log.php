...
class log
{
    ...
    public static $log_file = "data/enovel.log";
    ...
    public static function msg($msg, $log_type)
    {
        ...
        if (!in_array($log_type, array('info', 'debug')) || self::$log_write) {
    ...
    public static function _echo($msg)
    {
        if (strtoupper(substr(PHP_OS, 0, 3)) == "WIN") {
            echo iconv("UTF-8", "GB2312//IGNORE", $msg); //win下转换编码
        } else {
            echo $msg;
        }
    }

...
require PATH_ROOT . '/config/spider_config.php';
require PATH_ROOT . '/config/inc_mimetype.php';
...
{
    require PATH_LIBRARY . '/' . $classname . '.php';
}
...
if (version_compare(PHP_VERSION, '5.4.0', 'lt')) {
    log::_echo('PHP 5.4+ is required, currently installed version is: ' . phpversion()); //因为没有new phpspider()所以log类只能用_echo
    exit;
}
